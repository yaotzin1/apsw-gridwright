...
export const fr: LocaleCatalog = {
    ...
    addons: {
        'gridwright:column-layout': {
            ...
            moved: '{column} déplacée en position {position} sur {total}',
        },
        'gridwright:search': {
        ...
        'gridwright:row-detail': {
            expand: 'Afficher les détails de {row}',
            collapse: 'Masquer les détails de {row}',
            column: 'Détails',
            panel: 'Détails de {row}',
